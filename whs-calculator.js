...
function selectCourse() {
  ...
  document.getElementById("gender-section").style.display = selectedCourse ? "block" : "none";
...
window.onload = () => {
  if (document.getElementById("baan")) {
    document.getElementById("baan").value = "haagsche";
    selectCourse();
